...
DigitalReadout = lib.ReadDigitalDigitClass.ReadDigitalDigit()
...
class SimpleHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if "url=" in self.path:
            ...
            ###################################################################################################
            result = DigitalReadout.Readout(filelist)
            txt = 'Original: <p><img src=/image_tmp/original.jpg></img><p>'
            txt = txt + 'Resize (32x20): <p><img src=/image_tmp/resize.jpg></img><p>'
            txt = txt + "Readout:\t" + "{:.0f}".format(result[0])
            self.send_response(200)
